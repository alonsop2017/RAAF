...
touch logs/app.log logs/access.log logs/pcr_sync.log logs/backup.log logs/email_ingestion.log logs/health_check.log logs/rotate_logs.log logs/cleanup_unmatched.log logs/weekly_disk_report.log
chmod 664 logs/app.log logs/access.log logs/pcr_sync.log logs/backup.log logs/email_ingestion.log logs/health_check.log logs/rotate_logs.log logs/cleanup_unmatched.log logs/weekly_disk_report.log 2>/dev/null || true
