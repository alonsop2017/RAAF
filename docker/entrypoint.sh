...
touch logs/app.log logs/access.log logs/pcr_sync.log logs/backup.log logs/email_ingestion.log logs/health_check.log
chmod 664 logs/app.log logs/access.log logs/pcr_sync.log logs/backup.log logs/email_ingestion.log logs/health_check.log 2>/dev/null || true
